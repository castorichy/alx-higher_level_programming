This repo contains all highlevel pojects done

A high-level language (HLL) is a programming language such as pythonthat enables a programmer to write programs
